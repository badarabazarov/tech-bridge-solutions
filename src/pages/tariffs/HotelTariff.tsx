...
const HotelTariff = () => {
  ...
  const tariffPlans = [
    {
      name: t('tariffs.hotel.basic.name'),
      price: t('tariffs.hotel.basic.price'),
      description: t('tariffs.hotel.basic.description'),
      features: [
        t('tariffs.hotel.basic.feature1'),
        t('tariffs.hotel.basic.feature2'),
        t('tariffs.hotel.basic.feature3'),
        t('tariffs.hotel.basic.feature4')
      ]
    },
    {
      name: t('tariffs.hotel.standard.name'),
      price: t('tariffs.hotel.standard.price'),
      description: t('tariffs.hotel.standard.description'),
      features: [
        t('tariffs.hotel.standard.feature1'),
        t('tariffs.hotel.standard.feature2'),
        t('tariffs.hotel.standard.feature3'),
        t('tariffs.hotel.standard.feature4'),
        t('tariffs.hotel.standard.feature5')
      ],
      popular: true
    },
    {
      name: t('tariffs.hotel.premium.name'),
      price: t('tariffs.hotel.premium.price'),
      description: t('tariffs.hotel.premium.description'),
      features: [
        t('tariffs.hotel.premium.feature1'),
        t('tariffs.hotel.premium.feature2'),
        t('tariffs.hotel.premium.feature3'),
        t('tariffs.hotel.premium.feature4'),
        t('tariffs.hotel.premium.feature5'),
      ]
    }
  ];
        ...
        <main className="flex-grow">
          <section className="bg-gray-50 py-16">
            <div className="container mx-auto px-4">
              <h1 className="text-4xl font-bold text-center mb-4">{t('tariffs.hotel.title')}</h1>
              <p className="text-lg text-center text-gray-600 mb-12 max-w-3xl mx-auto">
                {t('tariffs.hotel.subtitle')}
              </p>
