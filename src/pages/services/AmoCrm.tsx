...
const AmoCrm = () => {
  ...
  return (
    <ServiceLayout 
      title={t('services.crm.amocrm.title')} 
      description={t('services.crm.amocrm.subtitle')}
    >
      <section className="py-12">
        <div className="container mx-auto">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold mb-8">{t('services.crm.amocrm.why')}</h2>
            <p className="text-lg text-gray-600 mb-6">
              {t('services.crm.amocrm.whyDescription')}
            </p>
            
            <h3 className="text-2xl font-bold mt-12 mb-6">{t('services.crm.amocrm.reasons')}</h3>
